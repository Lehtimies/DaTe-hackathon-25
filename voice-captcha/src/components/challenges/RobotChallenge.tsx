  ...
  return (
      <div className="p-8 max-w-[55rem] mg-auto flex flex-col text-center justify-center items-center text-white">
			...
			<div className="flex flex-col items-center">
				<CaptchaChallenge challengeText="In this test Albin has decided that since the Dateit spends so much time around machines, they must have taken on the qualities of them as well. To pass this Captcha you have to talk like a Robot, in beeps and boops." volumeTarget={30} minFrequency={300} maxFrequency={1000} words={["beep", "boop", "zoink"]} onResult={(res: any) => setResult(res)} />
				<Visualizer />
			</div>
