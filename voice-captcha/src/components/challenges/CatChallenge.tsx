    ...
    return (
        <div className="p-8 max-w-[55rem] mg-auto flex flex-col text-center justify-center items-center text-white">
            ...
            <div className="flex flex-col items-center">
                <CaptchaChallenge challengeText="'Meow' into the microphone like a cat to confirm your humanity. Albin has designed this Captcha to fit the deranged qualities of the average Dateit." volumeTarget={30} minFrequency={300} maxFrequency={1000} words={["meow"]} onResult={(res: any) => setResult(res)} />
                <Visualizer />
            </div>
