...
const CatChallenge = ({ onResult }: { onResult: (res: any) => void }) => {
    ...
    return (
        <div className="bg-white p-8 rounded-md text-black">
            ...
            <CaptchaChallenge challengeText="Meow into the microphone like a cat to confirm your humanity" volumeTarget={25} minFrequency={30} maxFrequency={100000} words={["meow"]} onResult={(res: any) => setResult(res)} />
            <Visualizer />
