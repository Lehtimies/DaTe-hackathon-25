	...
	return (
		<div className="p-8 max-w-[55rem] mg-auto flex flex-col text-center justify-center items-center text-white">
			  ...
			  <div className="flex flex-col items-center">
					<CaptchaChallenge challengeText="During Albin's many years of existence, he has heard many a Dateit complain about the difficulty of Tom Fredman's math courses, especially the dreaded Sigbe. So a true Dateit would take any opportunity to let out all the anger and frustration they are feeling from Sigbe. In this assignment you shall simply yell as loud as you can, to prove your Dateitness." volumeTarget={50} minFrequency={300} maxFrequency={2500} words={null} onResult={(res: any) => setResult(res)} />
					<Visualizer />
			  </div>
